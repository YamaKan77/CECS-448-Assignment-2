...
function dv_baseHandler(){function H(b){try{var c=new URL(b);return!c.pathname||""==c.pathname||"/"==c.pathname}catch(d){}}function I(b){var c="http:",d=window._dv_win.location.toString().match("^http(?:s)?");"https"!=b.match("^https")||"https"!=d&&"http"==d||(c="https:");return c}function N(){var b="http:";"http:"!=window._dv_win.location.protocol&&(b="https:");return b}function O(b){var c=window._dv_win.dvRecoveryObj;if(c){var d=dv_GetParam(b.dvparams,"ctx",!0);c=c[d]?c[d].RecoveryTagID:c._fallback_?
...
window._dv_win.frames[b.name].document)return c}catch(d){}return null}function S(){function b(c){d++;var e=c.parent==c;return c.mraid||e?c.mraid:20>=d&&b(c.parent)}var c=window._dv_win||window,d=0;try{return b(c)}catch(f){}}function K(b,c,d,f,e,g,k,h){var u=window._dv_win.dv_config&&window._dv_win.dv_config.bst2tid?window._dv_win.dv_config.bst2tid:dv_GetRnd();var C=window.parent.postMessage&&window.JSON;var l=!0;var n=!1;if("0"==dv_GetParam(b.dvparams,"t2te")||window._dv_win.dv_config&&1==window._dv_win.dv_config.supressT2T)n=
!0;if(C&&0==n)try{n="https://cdn3.doubleverify.com/bst2tv3.html";window._dv_win&&window._dv_win.dv_config&&window._dv_win.dv_config.bst2turl&&(n=window._dv_win.dv_config.bst2turl);var m=J(n,"bst2t_"+u);l=F(m)}catch(y){}var t=(n=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream)?"https:":I(k.src),D="0";"https:"==t&&(D="1");m=b.rand;var E="__verify_callback_"+m,z="__tagObject_callback_"+
m;T(E,b);U(z,k,b,n);void 0==b.dvregion&&(b.dvregion=0);var p="";m=k="";try{for(var x=d,v=0;10>v&&x!=window.top;)v++,x=x.parent;d.depth=v;dv_additionalUrl=V(d);k="&aUrl="+encodeURIComponent(dv_additionalUrl.url);m="&aUrlD="+dv_additionalUrl.depth;p=d.depth+f;e&&d.depth--}catch(y){m=k=p=d.depth=""}void 0!=b.aUrl&&(k="&aUrl="+b.aUrl);f=W();e=window._dv_win&&window._dv_win.dv_config&&window._dv_win.dv_config.verifyJSCURL?dvConfig.verifyJSCURL+"?":t+"//rtb"+b.dvregion+".doubleverify.com/verifyc.js?";a:{t=
window._dv_win;x=0;try{for(;10>x;){if(t.maple&&"object"===typeof t.maple){var w=!0;break a}if(t==t.parent){w=!1;break a}x++;t=t.parent}}catch(y){}w=!1}b=e+b.dvparams+"&num=5&srcurlD="+d.depth+"&callback="+E+"&jsTagObjCallback="+z+"&ssl="+D+(n?"&dvf=0":"")+(w?"&dvf=1":"")+"&refD="+p+"&htmlmsging="+(C?"1":"0")+"&guid="+u+(null!=f?"&aadid="+f:"");c="dv_url="+encodeURIComponent(c);if(0==l||g)b=b+("&dvp_isBodyExistOnLoad="+(l?"1":"0"))+("&dvp_isOnHead="+(g?"1":"0"));S()&&(b+="&ismraid=1");h&&(b+="&dvp_sfr=1");
if((g=window[G("=@42E:@?")][G("2?46DE@C~C:8:?D")])&&0<g.length){h=[];h[0]=window.location.protocol+"//"+window.location.hostname;for(l=0;l<g.length;l++)h[l+1]=g[l];g=h.reverse().join(",")}else g=null;g&&(c+="&ancChain="+encodeURIComponent(g));if(0==/MSIE (\d+\.\d+);/.test(navigator.userAgent)||7<new Number(RegExp.$1)||2E3>=k.length+m.length+b.length)b+=m,c+=k;if(void 0!=window._dv_win.$dvbsr.CommonData.BrowserId&&void 0!=window._dv_win.$dvbsr.CommonData.BrowserVersion&&void 0!=window._dv_win.$dvbsr.CommonData.BrowserIdFromUserAgent)l=
...
0,{}));c.hasOwnProperty("err")&&(b=c.err);return{vdcv:26,vdcd:c.res,err:b}}catch(d){return{vdcv:26,vdcd:"0",err:b}}}function M(b){var c=0,d;for(d in b)b.hasOwnProperty(d)&&++c;return c}function ba(b,c){a:{var d={};try{if(b&&b.performance&&b.performance.getEntries){var f=b.performance.getEntries();for(b=0;b<f.length;b++){var e=f[b],g=e.name.match(/.*\/(.+?)\./);if(g&&g[1]){var k=g[1].replace(/\d+$/,""),h=c[k];if(h){for(var u=0;u<h.stats.length;u++){var C=h.stats[u];d[h.prefix+C.prefix]=Math.round(e[C.name])}delete c[k];
if(!M(c))break}}}}var l=d;break a}catch(n){}l=void 0}if(l&&M(l))return l}function U(b,c,d,f){var e=f?"https:":N(),g=f?"https:":I(c.src),k="0";"https:"===g&&(k="1");var h=window._dv_win.document.visibilityState;window[b]=function(b){try{var f={};f.protocol=e;f.ssl=k;f.dv_protocol=g;f.serverPublicDns=b.ServerPublicDns;f.ServerPublicDns=b.ServerPublicDns;f.tagElement=c;f.redirect=d;f.impressionId=b.ImpressionID;window._dv_win.$dvbsr.tags.add(b.ImpressionID,f);if(c.dvFrmWin){var l=window._dv_win.$dvbsr;
c.dvFrmWin.$uid=b.ImpressionID;l.messages&&l.messages.startSendingEvents&&l.messages.startSendingEvents(c.dvFrmWin,b.ImpressionID)}(function(){function c(){var g=window._dv_win.document.visibilityState;"prerender"===h&&"prerender"!==g&&"unloaded"!==g&&(h=g,window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,{prndr:0}),window._dv_win.document.removeEventListener(d,c))}if("prerender"===h)if("prerender"!==window._dv_win.document.visibilityState&&"unloaded"!==visibilityStateLocal)window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,
{prndr:0});else{var d;"undefined"!==typeof window._dv_win.document.hidden?d="visibilitychange":"undefined"!==typeof window._dv_win.document.mozHidden?d="mozvisibilitychange":"undefined"!==typeof window._dv_win.document.msHidden?d="msvisibilitychange":"undefined"!==typeof window._dv_win.document.webkitHidden&&(d="webkitvisibilitychange");window._dv_win.document.addEventListener(d,c,!1)}})();var n=ba(window,{verifyc:{prefix:"vf",stats:[{name:"duration",prefix:"dur"}]}});n&&window._dv_win.$dvbsr.registerEventCall(b.ImpressionID,
n)}catch(m){}}}function T(b,c){window[b]=function(b){try{if(void 0==b.ResultID)document.write(1!=b?c.tagsrc:c.altsrc);else switch(b.ResultID){case 1:b.Passback?document.write(decodeURIComponent(b.Passback)):document.write(c.altsrc);break;case 2:case 3:document.write(c.tagsrc)}}catch(f){}}}function V(b){try{if(1>=b.depth)return{url:"",depth:""};var c=[];c.push({win:window.top,depth:0});for(var d,f=1,e=0;0<f&&100>e;){try{if(e++,d=c.shift(),f--,0<d.win.location.toString().length&&d.win!=b)return 0==
d.win.document.referrer.length||0==d.depth?{url:d.win.location,depth:d.depth}:{url:d.win.document.referrer,depth:d.depth-1}}catch(h){}var g=d.win.frames.length;for(var k=0;k<g;k++)c.push({win:d.win.frames[k],depth:d.depth+1}),f++}return{url:"",depth:""}}catch(h){return{url:"",depth:""}}}function G(b){new String;var c=new String,d;for(d=0;d<b.length;d++){var f=b.charAt(d);var e="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".indexOf(f);0<=e&&(f="!\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~".charAt((e+
47)%94));c+=f}return c}function X(){try{if(null!=window._phantom||null!=window.callPhantom)return 99;if(document.documentElement.hasAttribute&&document.documentElement.hasAttribute("webdriver")||null!=window.domAutomation||null!=window.domAutomationController||null!=window._WEBDRIVER_ELEM_CACHE)return 98;if(void 0!=window.opera&&void 0!=window.history.navigationMode||void 0!=window.opr&&void 0!=window.opr.addons&&"function"==typeof window.opr.addons.installExtension)return 4;if(void 0!=window.chrome&&
...
e.querySelector('body>div[id="kt_player"]'),null!=a&&null!=a.querySelector('div[class="flash-blocker"]')):!1);f(17,11,null!=b.clickplayer&&null!=b.checkRdy2);f(19,12,b.instance&&b.inject&&e.querySelector('path[id="cp-search-0"]'));return{f:c,s:d}}catch(g){return null}}function W(){function b(b){if(null==b||""==b)return"";var c=function(b,c){return b<<c|b>>>32-c},d=function(b){for(var c="",d,e=7;0<=e;e--)d=b>>>4*e&15,c+=d.toString(16);return c},e=[1518500249,1859775393,2400959708,3395469782];b+=String.fromCharCode(128);
for(var f=Math.ceil((b.length/4+2)/16),g=Array(f),n=0;n<f;n++){g[n]=Array(16);for(var m=0;16>m;m++)g[n][m]=b.charCodeAt(64*n+4*m)<<24|b.charCodeAt(64*n+4*m+1)<<16|b.charCodeAt(64*n+4*m+2)<<8|b.charCodeAt(64*n+4*m+3)}g[f-1][14]=8*(b.length-1)/Math.pow(2,32);g[f-1][14]=Math.floor(g[f-1][14]);g[f-1][15]=8*(b.length-1)&4294967295;b=1732584193;m=4023233417;var t=2562383102,D=271733878,E=3285377520,z=Array(80);for(n=0;n<f;n++){for(var p=0;16>p;p++)z[p]=g[n][p];for(p=16;80>p;p++)z[p]=c(z[p-3]^z[p-8]^z[p-
14]^z[p-16],1);var x=b;var v=m;var w=t;var r=D;var q=E;for(p=0;80>p;p++){var A=Math.floor(p/20),B=c(x,5);a:{switch(A){case 0:var y=v&w^~v&r;break a;case 1:y=v^w^r;break a;case 2:y=v&w^v&r^w&r;break a;case 3:y=v^w^r;break a}y=void 0}A=B+y+q+e[A]+z[p]&4294967295;q=r;r=w;w=c(v,30);v=x;x=A}b=b+x&4294967295;m=m+v&4294967295;t=t+w&4294967295;D=D+r&4294967295;E=E+q&4294967295}return d(b)+d(m)+d(t)+d(D)+d(E)}function c(){try{return!!window.sessionStorage}catch(g){return!0}}function d(){try{return!!window.localStorage}catch(g){return!0}}
function f(){try{var b=document.createElement("canvas");if(b.getContext&&b.getContext("2d")){var c=b.getContext("2d");c.textBaseline="top";c.font="14px 'Arial'";c.textBaseline="alphabetic";c.fillStyle="#f60";c.fillRect(0,0,62,20);c.fillStyle="#069";c.fillText("!image!",2,15);c.fillStyle="rgba(102, 204, 0, 0.7)";c.fillText("!image!",4,17);return b.toDataURL()}}catch(h){}return null}try{var e=[];e.push(["lang",navigator.language||navigator.browserLanguage]);e.push(["tz",(new Date).getTimezoneOffset()]);
...
!0);break}}catch(h){b=!1}if(0==c.document.referrer.length)b=c.location;else if(b)b=c.location;else{b=c.document.referrer;if(H(b)){a:{try{var e=c.$sf&&c.$sf.ext&&c.$sf.ext.hostURL&&c.$sf.ext.hostURL();break a}catch(h){}e=void 0}if(e&&!H(e)&&0==e.indexOf(b)){b=e;var g=!0}}f=!0}if(!window._dv_win.bsredirect5ScriptsInternal||!window._dv_win.bsredirect5Processed||0==window._dv_win.bsredirect5ScriptsInternal.length)return{isSev1:!1,url:null};this.dv_script_obj=e=P();e=this.dv_script=e.script;var k=e.src.replace(/^.+?callback=(.+?)(&|$)/,
"$1");if(k&&(this.redirect=eval(k+"()"))&&!this.redirect.done){this.redirect.done=!0;if(O(this.redirect))return{isSev1:!0};c=K(this.redirect,b,c,d,f,e&&e.parentElement&&e.parentElement.tagName&&"HEAD"===e.parentElement.tagName,e,g);c+="&"+this.getVersionParamName()+"="+this.getVersion();return{isSev1:!1,url:c}}};this.isApplicable=function(){return!0};this.onFailure=function(){};this.sendRequest=function(b){dv_sendRequest(b);try{var c=Q(this.dv_script_obj&&this.dv_script_obj.injScripts),d=J("about:blank");
d.id=d.name;var f=d.id.replace("iframe_","");d.setAttribute&&d.setAttribute("data-dv-frm",f);F(d,this.dv_script);if(this.dv_script){var e=this.dv_script;a:{b=null;try{if(b=d.contentWindow){var g=b;break a}}catch(u){}try{if(b=window._dv_win.frames&&window._dv_win.frames[d.name]){g=b;break a}}catch(u){}g=null}e.dvFrmWin=g}var k=R(d);if(k)k.open(),k.write(c);else{try{document.domain=document.domain}catch(u){}var h=encodeURIComponent(c.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));d.src='javascript: (function(){document.open();document.domain="'+
window.document.domain+"\";document.write('"+h+"');})()"}}catch(u){c=(window._dv_win.dv_config=window._dv_win.dv_config||{}).tpsAddress||"tps30.doubleverify.com",dv_SendErrorImp(c+"/verifyc.js?ctx=818052&cmp=1619415",[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(u)}])}return!0};window.debugScript&&(!window.minDebugVersion||10>=window.minDebugVersion)&&(window.DvVerify=K,window.createRequest=this.createRequest);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"67"}}
;
